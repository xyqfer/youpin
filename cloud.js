...
const cloudFuncConfig = [
    ...
    {
        name: 'updateDaily_en',
        module: ['updateOctocat', 'updateSSpaiMatrix', 'updateBookset', 'updateTerminus'],
        info: '每日更新_en'
    },
    {
        name: 'updateKonachan',
    ...
    {
        name: 'update3PerDay',
        module: ['updateJuejin', 'updateWechatAnnounce'],
        info: '每日三更'
    },
    {
        name: 'updateDaily',
        module: ['updateBook', 'updateCodrop', 'updateOSChina', 'updateKelemiao', 'updateNotchPic', 'updateNanfengchuang'],
        info: '每日更新'
    },
    {
        name: 'updateBlog',
